...
curut.get(function(req,res,next){
    ...
    req.getConnection(function(err,conn){
        ...
        if (err) return next("Cannot Connect1" + err);
...
curut.post(function(req,res,next){
    ...
    req.getConnection(function (err, conn){
        ...
        if (err) return next("Cannot Connect2");
...
curut2.get(function(req,res,next){
    ...
    req.getConnection(function(err,conn){
        ...
        if (err) return next("Cannot Connect3");
...
curut2.put(function(req,res,next){
    ...
    req.getConnection(function (err, conn){
        ...
        if (err) return next("Cannot Connect4");
...
curut2.delete(function(req,res,next){
    ...
    var user_id = req.params.user_id;
     ...
     req.getConnection(function (err, conn) {
        ...
        if (err) return next("Cannot Connect5");
